...
import { ARBITRUM, PEGASUS, PHOENIX, PUPPYNET } from "config/chains";
import { arbitrumReferralsGraphClient, pegasusReferralsGraphClient, phoenixReferralsGraphClient, puppynetReferralsGraphClient } from "lib/subgraph/clients";
...
function getGraphClient(chainId) {
  if (chainId === ARBITRUM) {
    ...
    return puppynetReferralsGraphClient;
  }
