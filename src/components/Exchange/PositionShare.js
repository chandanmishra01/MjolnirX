...
import ampLogo from "img/logo_with_name_dark.svg";
...
import shareBgImg from "img/position-share-bg.jpeg";
...
function PositionShare({ setIsPositionShareModalOpen, isPositionShareModalOpen, positionToShare, account, chainId }) {
  ...
  const tweetLink = getTwitterIntentURL(
    `Latest $${positionToShare?.indexToken?.symbol} trade on @amped`,
  ...
  function handleCopy() {
    ...
    const url = "http://amped.finance/#/trade/?ref=" + userAffiliateCode.code;
    copyToClipboard(url);
