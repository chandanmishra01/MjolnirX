...
export default function Home() {
  const dataBenefits = [
    ...
    },
    {
      ...
      icon: benefit4,
      des: "Amplify your trading potential with leveraged trading on Mjolnir Exchnage. Our platform allows for significant leverage, giving you the power to maximize your trading strategy and potential returns.",
    },
  ];
