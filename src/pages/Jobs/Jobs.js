        ...
        <div className="section-title-block">
          ...
          <div className="section-title-content">
            ...
            <div className="Page-description">
              <Trans>Job openings at AMP.</Trans>
            </div>
          </div>
        </div>
...
function NoJob() {
  return (
    <Card title={t`No open positions at AMP currently`}>
      <div className="body-para">
        <p className="subheading">
          <Trans>
          AMP is not actively looking for new hires at the moment. However, if you think you can contribute to the
            project, please email <ExternalLink href="mailto:jobs@amp.io">jobs@amp.io</ExternalLink>.
          </Trans>
        </p>
      </div>
    </Card>
...
//         <ul>
//           <li>Work closely with the AMP team on the AMP front-end website.</li>
...
//           </ul>
//           <p>The salary is 60,000 to 120,000 USD + 1,000 to 3,000 AMP a year.</p>
//           <p className="jobs-contact">
//             If the job suits you, please get in touch with{" "}
//             <a target="_blank" href="mailto:jobs@amp.io" rel="noopener noreferrer">
//               jobs@amp.io
//             </a>{" "}
